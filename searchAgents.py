...
def cornersHeuristic(state, problem):
    ...
    if len(unvisitedCorners) > 0:
        ...
        farthestPoint = findFarthestPoint(current_location,
                                          unvisitedCorners)  # distance btwn current node and to all corner nodes
        ...
        currentToClosest = mazeDistance(current_location, closestNode,
                                        currentNode)  # distance btwn current location and closest manhattan node
...
def foodHeuristic(state, problem):
    ...
    if len(foodList) > 0:  # distance btwn food nodes and current node
        ...
        currentToClosest = mazeDistance(position, closestFoodNode,
                                        currentNode)  # distance btwn current location and closest manhattan node
